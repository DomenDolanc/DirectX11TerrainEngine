...
void ::Terrain_engine::DirectXPage::InitializeComponent()
{
    if (_contentLoaded)
    {
        return;
...
void ::Terrain_engine::DirectXPage::Connect(int __connectionId, ::Platform::Object^ __target)
{
    ...
    case 4:
        {
            ...
            (safe_cast<::Windows::UI::Xaml::Controls::AppBarButton^>(element4))->Click += ref new ::Windows::UI::Xaml::RoutedEventHandler(this, (void (::Terrain_engine::DirectXPage::*)
...
::Windows::UI::Xaml::Markup::IComponentConnector^ ::Terrain_engine::DirectXPage::GetBindingConnector(int __connectionId, ::Platform::Object^ __target)
{
