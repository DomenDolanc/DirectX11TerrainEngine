...
namespace Terrain_engine
{
    ...
    public:
        ...
        ID3D11DepthStencilView* GetWaterDepthStencilView() const { return m_d3dWaterDepthStencilView.Get(); }
    ...
    private:
        ...
        Microsoft::WRL::ComPtr<ID3D11DepthStencilView>	m_d3dWaterDepthStencilView;
    };
}